    ...
    >
      <SidebarWrapper class="h-full">
        <SidebarGroup>
          ...
          <SidebarItem label="Templates" href="/user/order-templates" class="text-black font-semibold hover:bg-gray-200 rounded-md p-2">
            <svelte:fragment slot="icon">
              <ChartPieSolid class="w-6 h-6 text-black transition duration-75 group-hover:text-gray-700" />
            </svelte:fragment>
          </SidebarItem>
  
          <SidebarItem label="Cart" href="/user/cart" class="text-black font-semibold hover:bg-gray-200 rounded-md p-2">
            <svelte:fragment slot="icon">
